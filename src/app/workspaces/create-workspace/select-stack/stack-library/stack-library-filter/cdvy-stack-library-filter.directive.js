...
/**
 * @ngdoc directive
 * @name projects.create.directive:codenvyStackLibraryFilterCtrl
 * @restrict E
 * @element
 *
 * @description
 * `<cdvy-stack-library-filter></cdvy-stack-library-filter>` for creating new tags filter
 *
 * @author Oleksii Kurinnyi
 */
export class CodenvyStackLibraryFilter {
  ...
  constructor () {
    this.restrict = 'E';
    this.templateUrl = 'app/workspaces/create-workspace/select-stack/stack-library/stack-library-filter/cdvy-stack-library-filter.html';

    this.controller = 'CodenvyStackLibraryFilterCtrl';
    this.controllerAs = 'codenvyStackLibraryFilterCtrl';
  ...
  link($scope, element) {
    let ctrl = $scope.codenvyStackLibraryFilterCtrl;
