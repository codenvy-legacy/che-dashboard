...
/**
 * Test of the CodenvyProjectType
 */
describe('CodenvyProjectType', function(){
   ...
   */
  beforeEach(inject(function(codenvyProjectType, codenvyAPIBuilder, codenvyHttpBackend) {
    factory = codenvyProjectType;
